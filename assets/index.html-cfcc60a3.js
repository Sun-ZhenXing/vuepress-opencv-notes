...
`),a("span",{class:"token builtin class-name"},"cd"),s(` opencv-4.7.0
md build
`)])])],-1),O=k(`<p>需要预先安装编译依赖，Windows 系统见下文。例如 Ubuntu 的基本依赖为：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> build-essential cmake <span class="token function">git</span> pkg-config libgtk-3-dev <span class="token punctuation">\\</span>
...
</code></pre></div><h2 id="_2-构建-qt-支持" tabindex="-1"><a class="header-anchor" href="#_2-构建-qt-支持" aria-hidden="true">#</a> 2. 构建 Qt 支持</h2><p>如果需要编译基于 Qt 的图形界面，启用 <code>-D WITH_QT=ON</code> 来编译，例如：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>cmake <span class="token parameter variable">-D</span> <span class="token assign-left variable">CMAKE_BUILD_TYPE</span><span class="token operator">=</span>RELEASE <span class="token punctuation">\\</span>
