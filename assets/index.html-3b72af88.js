import{_ as n,p as s,q as a,a1 as t}from"./framework-35c50e38.js";const p={},e=t(`<h1 id="python-opencv-目标分割" tabindex="-1"><a class="header-anchor" href="#python-opencv-目标分割" aria-hidden="true">#</a> Python OpenCV 目标分割</h1><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> cv2
